...
{
    [ExportCodeFixProvider(LanguageNames.CSharp, Name = nameof(SerializePolymorphicPropertyNameCodeFixProvider)), Shared]
    public class SerializePolymorphicPropertyNameCodeFixProvider : CodeFixProvider
    {
        public sealed override ImmutableArray<string> FixableDiagnosticIds => ImmutableArray.Create(
            SerializePolymorphicPropertyNameAnalyzer.NotFoundDiagnosticId,
            SerializePolymorphicPropertyNameAnalyzer.WrongTypeDiagnosticId,
            SerializePolymorphicPropertyNameAnalyzer.DeclaredAfterPropertyDiagnosticId);
        ...
        public sealed override async Task RegisterCodeFixesAsync(CodeFixContext context)
        {
            ...
            if (argument != null)
            {
                if (diagnostic.Id == SerializePolymorphicPropertyNameAnalyzer.NotFoundDiagnosticId)
                {
