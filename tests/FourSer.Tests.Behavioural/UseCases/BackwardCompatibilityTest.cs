...
public class BackwardCompatibilityTest
{
    ...
    public void PrimitiveTypesBackwardCompatibilityTest()
    {
        ...
        Assert.Equal(original.bResult, deserialized.bResult);
        Assert.Equal(original.dwUserID, deserialized.dwUserID);
        Assert.Equal(original.dwKickID, deserialized.dwKickID);
        Assert.Equal(original.dwKEY, deserialized.dwKEY);
        Assert.Equal(original.Address, deserialized.Address);
        Assert.Equal(original.Port, deserialized.Port);
        Assert.Equal(original.bCreateCardCnt, deserialized.bCreateCardCnt);
        Assert.Equal(original.bInPcRoom, deserialized.bInPcRoom);
        Assert.Equal(original.dwPremiumPcRoom, deserialized.dwPremiumPcRoom);
        Assert.Equal(original.dCurrentTime, deserialized.dCurrentTime);
        Assert.Equal(original.dKey, deserialized.dKey);
    }
    ...
    public void StringTypesBackwardCompatibilityTest()
    {
        ...
        Assert.Equal(original.wVersion, deserialized.wVersion);
        Assert.Equal(original.strUserID, deserialized.strUserID);
        Assert.Equal(original.strPasswd, deserialized.strPasswd);
        Assert.Equal(original.dlCheck, deserialized.dlCheck);
    }
    ...
    public void CollectionAttributesBackwardCompatibilityTest()
    {
        ...
        Assert.True(countTypeTest.MyList.SequenceEqual(deserialized1.MyList));
        ...
        Assert.Equal(countSizeRefTest.MyListCount, deserialized2.MyListCount);
        Assert.True(countSizeRefTest.MyList.SequenceEqual(deserialized2.MyList));
    }
